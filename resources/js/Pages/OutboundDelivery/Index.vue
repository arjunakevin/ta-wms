    ...
    <div>
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Outbound Delivery</li>
                    </ol>
                </nav>
                <h4 class="mg-b-0 tx-spacing--1">Outbound Delivery List</h4>
            </div>
            <div class="d-none d-md-block">
                ...
                <Link :href="$route('outbounds.create')" as="button" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"><i data-feather="plus" class="wd-10 mg-r-5"></i> Create Outbound Delivery</Link>
            </div>
        </div>
        <Table :data="data" :columnDefs="columnDefs" view-route="outbounds.show"/>
...
export default {
        ...
        return {
            ...
            columnDefs: {
                header: [
                    ...
                    { label: 'Reference' },
                    { label: 'Client Code' },
                    { label: 'Req. Del. Date', style: 'width: 200px', class: 'text-center' },
                    { label: 'Dest. Name' },
                    { label: 'Dest. Phone' },
                ...
                row: [
                    ...
                    { data: 'client.code' },
                    { data: 'request_delivery_date', tdClass: 'text-center' },
                    { data: 'destination_name' },
                    { data: 'destination_phone' },
                    { data: 'details_count', tdClass: 'text-center' },
                    { data: 'status', tdClass: 'text-center', render: this.getOutboundStatusLabel  }
                ]
            }
        }
    },
    methods: {
        filter() {
            this.form.get(this.$route('outbounds.index'), {
                preserveState: true,
                onBefore: () => {
